...
DR_PARAM_DEFINE_YAML_DECODE(int16_t, node)   { return convert_signed_integral<int16_t>(node); }
DR_PARAM_DEFINE_YAML_DECODE(int    , node)   { return convert_signed_integral<int    >(node); }
DR_PARAM_DEFINE_YAML_DECODE(long, node)      { return convert_signed_integral<long>(node); } //NOLINT
DR_PARAM_DEFINE_YAML_DECODE(long long, node) { return convert_signed_integral<long long>(node); } //NOLINT

DR_PARAM_DEFINE_YAML_DECODE(unsigned char      , node) { return convert_unsigned_integral<unsigned char     >(node); }
DR_PARAM_DEFINE_YAML_DECODE(uint16_t           , node) { return convert_unsigned_integral<uint16_t          >(node); }
DR_PARAM_DEFINE_YAML_DECODE(unsigned int       , node) { return convert_unsigned_integral<unsigned int      >(node); }
DR_PARAM_DEFINE_YAML_DECODE(unsigned long      , node) { return convert_unsigned_integral<unsigned long     >(node); } //NOLINT
DR_PARAM_DEFINE_YAML_DECODE(unsigned long long , node) { return convert_unsigned_integral<unsigned long long>(node); } //NOLINT
...
YAML::Node estd::conversion<int16_t,   YAML::Node>::perform(int16_t value)   { return YAML::Node(value); }
YAML::Node estd::conversion<int,       YAML::Node>::perform(int     value)   { return YAML::Node(value); }
YAML::Node estd::conversion<long,      YAML::Node>::perform(long value)      { return YAML::Node(value); } //NOLINT
YAML::Node estd::conversion<long long, YAML::Node>::perform(long long value) { return YAML::Node(value); } //NOLINT

YAML::Node estd::conversion<unsigned char,      YAML::Node>::perform(unsigned char value)      { return YAML::Node(value); }
YAML::Node estd::conversion<uint16_t,           YAML::Node>::perform(uint16_t      value)      { return YAML::Node(value); }
YAML::Node estd::conversion<unsigned int,       YAML::Node>::perform(unsigned int  value)      { return YAML::Node(value); }
YAML::Node estd::conversion<unsigned long,      YAML::Node>::perform(unsigned long value)      { return YAML::Node(value); } //NOLINT
YAML::Node estd::conversion<unsigned long long, YAML::Node>::perform(unsigned long long value) { return YAML::Node(value); } //NOLINT
